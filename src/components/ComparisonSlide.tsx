    ...
    <div className="h-full w-full px-4 py-2 flex flex-col">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="mb-6 flex-1">
          <div className="relative bg-slate-800/30 rounded-2xl p-6 h-full overflow-hidden">
            ...
            <div className="relative flex items-end justify-center space-x-6 h-full">
              {comparisons.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`bg-gradient-to-t ${item.color} rounded-lg mb-3 flex items-end justify-center p-3 transition-all duration-1000`}
                      style={{
                        width: `${Math.max(50, item.scale * 250)}px`,
                        height: `${Math.max(60, item.scale * 300)}px`,
                      }}
                    >
                      <IconComponent className="text-white" size={Math.max(20, item.scale * 80)} />
                    </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {comparisons.map((item, index) => {
            ...
            return (
              <div
                key={item.item}
                className={`bg-slate-800/50 p-4 rounded-xl border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300 transform ${
              ...
              >
                ...
                <h3 className="text-lg font-bold text-white mb-3">{item.item}</h3>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-medium text-sm">{item.weight}</span>
                  </div>
                  
                  <div className="flex justify-between">
                    <span className="text-slate-400 text-sm">Power</span>
                    <span className="text-white font-medium text-sm">{item.power}</span>
                  </div>
                  
                  <div className="flex justify-between">
                    <span className="text-slate-400 text-sm">Speed</span>
                    <span className="text-white font-medium text-sm">{item.speed}</span>
                  </div>
                </div>
